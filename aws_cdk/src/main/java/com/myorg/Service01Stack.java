...
public class Service01Stack extends Stack {
    public Service01Stack(final Construct scope, final String id, Cluster cluster, SnsTopic producEventsTopic) {
        this(scope, id, null, cluster, producEventsTopic);
    }

    public Service01Stack(final Construct scope, final String id, final StackProps props, Cluster cluster,
            SnsTopic producEventsTopic) {
        ...
        ApplicationLoadBalancedFargateService service01 = ApplicationLoadBalancedFargateService.Builder
                ...
                .taskImageOptions(ApplicationLoadBalancedTaskImageOptions.builder().containerName("aws_project01")
                        .image(ContainerImage.fromRegistry("dhhiego/aws_project01:1.2.0")).containerPort(8080)
